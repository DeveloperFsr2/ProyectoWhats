...
const bodyParser = require('body-parser');
const cors = require('cors'); // Agrega la importación de CORS
const jwt = require('jsonwebtoken'); // Agrega la importación de JWT
...
client.on('authenticated', (session) => {
    ...
    // Generar un token JWT usando información de la sesión
    const token = jwt.sign({ sessionId: session }, 'tu_clave_secreta'); // Cambia 'tu_clave_secreta' por tu propia clave secreta

    // Imprimir el token en la consola del servidor Node.js
